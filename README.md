...
| `block_http_other_ports` | `1` | Seuls les ports 80, 443 et les ports VoIP/STUN sont autorisés. À mettre à `0` si un bac à sable ou une application métier cesse de fonctionner. |
